...
def Op(operation,model_name,batch_size,img_size,ratio,epochA,epochAW,weightParameter,LinearParameter):
    ...
    if operation == 'activationRetrainAfterWeightRetrain':
        patternW = 'retrain'
        makeDir(model_name, ratio)
        weightPruneModelOp(model_name, batch_size, img_size, ratio, patternW, epochAW, weightParameter, LinearParameter,operation='activationRetrainAfterWeightRetrain')

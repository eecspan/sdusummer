...
def weightPruneModelOp(model_name,batch_size,img_size,ratio,pattern,epoch,weightParameter,LinearParameter):
    ...
    if pattern == 'retrain':
        getPth = './pth/' + model_name  + '/ratio=' +str(ratio)+ '/Activation' + '/best.pth'
        ...
        train_model_jiang(net,dataloaders, dataset_sizes,ratio,'weight', criterion=criterion, optimizer=optimizer, name=model_name,
